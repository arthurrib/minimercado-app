package com.minimercado.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.minimercado.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.minimercado.repository.UserRepository.USERS_BY_EMAIL_CACHE);
