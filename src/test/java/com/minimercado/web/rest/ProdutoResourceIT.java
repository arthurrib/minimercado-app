...
class ProdutoResourceIT {
    ...
    public static Produto createEntity(EntityManager em) {
        Produto produto = new Produto().nome(DEFAULT_NOME).valor(DEFAULT_VALOR);
        return produto;
    }
    ...
    public static Produto createUpdatedEntity(EntityManager em) {
        Produto produto = new Produto().nome(UPDATED_NOME).valor(UPDATED_VALOR);
        return produto;
    }
    ...
    void putExistingProduto() throws Exception {
        ...
        updatedProduto.nome(UPDATED_NOME).valor(UPDATED_VALOR);
    ...
    void fullUpdateProdutoWithPatch() throws Exception {
        ...
        partialUpdatedProduto.nome(UPDATED_NOME).valor(UPDATED_VALOR);
